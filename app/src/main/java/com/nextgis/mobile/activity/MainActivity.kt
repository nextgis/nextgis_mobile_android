...
import com.nextgis.mobile.mapsafe.MaskDialog
...
//        }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.action_mask_layer -> {
                //Toast.makeText(this, "Mask Layer clicked", Toast.LENGTH_SHORT).show()
                showMaskLayerDialog()
                return true
            }
...
//            }
    ...
    private fun showMaskLayerDialog() {

        val dialog = MaskDialog(this) { minDist, maxDist ->

            mapFragment?.maskSelectedPointLayer(minDist, maxDist)
...
//            Toast.makeText(
//                this,
//                "Masking: $minDist to $maxDist",
//                Toast.LENGTH_SHORT
//            ).show()
//
//            // Next step: apply masking to layer
//        }
//
//        dialog.show()
//    }
...
//    private fun maskSelectedLayer(minDist: Double, maxDist: Double) {
//
//        val layer = mapFragment?.currentLayer  // or selected layer (may differ)
//
//        if (layer == null) {
//            Toast.makeText(this, "No layer selected", Toast.LENGTH_SHORT).show()
//            return
//        }
//
//        Toast.makeText(this, "Layer found: ${layer.name}", Toast.LENGTH_SHORT).show()
//    }
